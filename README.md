...
| 变量名 | 示例 | 必填 | 备注 | 
|-|-|-|-|
| TOKEN | `123` | ✅ | 汇聚订阅的订阅配置路径地址，例如：`/auto` | 
...
| TGTOKEN | `6894123456:XXXXXXXXXX0qExVsBPUhHDAbXXXXXqWXgBA` | ❌ | 7671478480:AAEwGOQpPRUWzUucDLooJGDGljBsLfVw88w | 
| TGID | `6946912345` | ❌ | 7219766675 | 
